...
import (
	...
	typedoperatorv1alpha1 "github.com/openshift-pipelines/operator/pkg/client/clientset/versioned/typed/operator/v1alpha1"
	...
	if untyped == nil {
		if injection.GetConfig(ctx) == nil {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/openshift-pipelines/operator/pkg/client/clientset/versioned.Interface from context. This context is not the application context (which is typically given to constructors via sharedmain).")
		} else {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/openshift-pipelines/operator/pkg/client/clientset/versioned.Interface from context.")
		}
	}
