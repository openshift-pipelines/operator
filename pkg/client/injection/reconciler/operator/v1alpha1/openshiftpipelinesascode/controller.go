...
import (
	...
	versionedscheme "github.com/openshift-pipelines/operator/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "openshiftpipelinesascode-controller"
	defaultFinalizerName       = "openshiftpipelinesascodes.operator.openshift-pipelines.org"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	openshiftpipelinesascodeInformer := openshiftpipelinesascode.Get(ctx)

	lister := openshiftpipelinesascodeInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.openshift-pipelines.org.OpenShiftPipelinesAsCode"),
	)
