...
const (
	defaultControllerAgentName = "pipelinesascode-controller"
	defaultFinalizerName       = "pipelinesascodes.operator.openshift-pipelines.org"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	pipelinesascodeInformer := pipelinesascode.Get(ctx)

	lister := pipelinesascodeInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.openshift-pipelines.org.PipelinesAsCode"),
	)
