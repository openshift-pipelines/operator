...
import (
	...
	apisoperatorv1alpha1 "github.com/openshift-pipelines/operator/pkg/apis/operator/v1alpha1"
	versioned "github.com/openshift-pipelines/operator/pkg/client/clientset/versioned"
	v1alpha1 "github.com/openshift-pipelines/operator/pkg/client/informers/externalversions/operator/v1alpha1"
	client "github.com/openshift-pipelines/operator/pkg/client/injection/client"
	factory "github.com/openshift-pipelines/operator/pkg/client/injection/informers/factory"
...
func Get(ctx context.Context) v1alpha1.OpenShiftPipelinesAsCodeInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift-pipelines/operator/pkg/client/informers/externalversions/operator/v1alpha1.OpenShiftPipelinesAsCodeInformer from context.")
	}
