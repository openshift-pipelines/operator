...
func Get(ctx context.Context) v1alpha1.PipelinesAsCodeInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/openshift-pipelines/operator/pkg/client/informers/externalversions/operator/v1alpha1.PipelinesAsCodeInformer from context.")
	}
