...
bash ${REPO_ROOT_DIR}/hack/generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/openshift-pipelines/operator/pkg/client github.com/openshift-pipelines/operator/pkg/apis \
  "operator:v1alpha1" \
...
${PREFIX}/deepcopy-gen \
  ...
  --go-header-file ${REPO_ROOT_DIR}/hack/boilerplate/boilerplate.go.txt \
  -i github.com/openshift-pipelines/operator/pkg/apis/operator/v1alpha1
